...
if __name__ == '__main__':
    ...
    if os.path.exists(positive_result_path):
        ...
        positive_result, utt2keyword_idx = inference_shift_batch(model, positive_list, (keyword, keyword_len), idx2keyword, keyword2idx, shift=pos_shift, speech_batch_size=speech_batch_size, cross_batch_size=cross_batch_size)
    ...
    if os.path.exists(negative_result_path):
        ...
        negative_result, _ = inference_shift_batch(model, negative_list, (keyword, keyword_len), idx2keyword, keyword2idx, shift=neg_shift, speech_batch_size=speech_batch_size, cross_batch_size=cross_batch_size)
