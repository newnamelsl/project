...
testdata_order = [
    ...
    'fyt_20zh_qingdao_test_aishell4',
    'fyt_20zh_qingdao_test_10eval_aishell4',
    'fyt_22zh_henan_test_aishell4',
    'fyt_22zh_henan_test_12eval_aishell4',
    'fyt_15zh_chongqing_test_aishell4',
    'fyt_15zh_chongqing_test_5eval_aishell4',
...
#target_subdir_pattern = re.compile(r"5000h_tang_ke_sinvxx_1-3s_lex_ft1_.*|5000h_tang_ke_sinvxx_1-3s_lex_hanlp1_.*|.*qingdao.*")
#target_subdir_pattern = re.compile(r"5000h_tang_ke_sinvxx_1-3s_lex_ft_.*|5000h_tang_ke_sinvxx_1-3s_lex_hanlp_.*|.*qingdao.*")
