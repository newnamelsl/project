...
def split_and_tokenize(text_obj, in_word2id, in_phone2id):
...
def main(text_scp, wav_scp, in_word2id, in_phone2id, out_word2id, out_phone2id, out_datalist, out_lexicon):
    ...
    tokenized_objs, word2id, phone2id, lexicon = split_and_tokenize(text_scp, in_word2id, in_phone2id)
...
if __name__ == '__main__':
    if len(sys.argv) != 9:
        print ("Usage: python hanlp_split.py text wav.scp in_word2id in_phone2id out_word2id out_phone2id out_datalist out_lexicon")
        exit()
    text_scp = sys.argv[1]
    wav_scp = sys.argv[2]
    ...
    main(text_scp, wav_scp, in_word2id, in_phone2id, out_word2id, out_phone2id, out_datalist, out_lexicon)
