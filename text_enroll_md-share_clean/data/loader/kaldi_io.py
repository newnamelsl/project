...
if not 'KALDI_ROOT' in os.environ:
  ...
  os.environ['KALDI_ROOT']='/freeneb/home/shiying/toolkit/kaldi/kaldi.5.5'

# Add kaldi tools to path,
os.environ['PATH'] = os.popen(
  'echo $KALDI_ROOT/src/bin:$KALDI_ROOT/tools/openfst/bin:' +
  ...
  '$KALDI_ROOT/src/fgmmbin/:$KALDI_ROOT/src/latbin/:$KALDI_ROOT/src/nnetbin:'+
  '$KALDI_ROOT/src/nnet2bin:$KALDI_ROOT/src/nnet3bin:$KALDI_ROOT/src/online2bin/:'+
