...
class TransformerKWSPhone_speech_only(nn.Module):
    def __init__(
        self,
        audio_net_config,
        kw_net_config,
        ...
        **kwargs,
        ...
        super(TransformerKWSPhone_speech_only, self).__init__()
        self.sok = sok
        self.eok = eok
        # detach_config 
        # TODO: looks stupid ....   >_<
        ...
        au_b_transformer_config = au_b_net_config['transformer_config']
        au_b_self_att = att_dict[au_b_transformer_config['self_att']]
        au_b_self_att_cofing = au_b_transformer_config['self_att_config']
        au_b_feed_forward_config = au_b_transformer_config['feed_forward_config']
        au_b_hidden_dim = au_b_transformer_config['size']
        ...
        self.au_b_transformer = nn.ModuleList([
            NM.TransformerLayer(
                size=au_b_hidden_dim,
                self_att=au_b_self_att(**au_b_self_att_cofing),
                feed_forward=NM.FNNBlock(**au_b_feed_forward_config),
            ) for _ in range(num_au_b_block)
        ])
