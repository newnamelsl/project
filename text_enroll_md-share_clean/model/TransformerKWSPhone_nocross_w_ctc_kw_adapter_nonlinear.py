...
class TransformerKWSPhone_nocross_w_ctc_kw_adapter_nonlinear(TransformerKWSPhone_nocross_w_ctc.TransformerKWSPhone_nocross_w_ctc):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(TransformerKWSPhone_nocross_w_ctc_kw_adapter_nonlinear, self).__init__(
        ...
        self.kw_adapter_trans = NM.FNNBlock(**kw_net_config['input_trans'])
